...
export function TermsAccordion() {
  return (
    <section
      id="terms"
      className="scroll-mt-24 bg-white px-6 pb-20 md:px-10 md:pb-28"
    >
      <div className="mx-auto max-w-3xl">
        ...
        <AccordionItem title="Promoción Mercado Pago*">
          <div className="space-y-2">
            ...
            <p>
              Aplica para Mercado Pago, BBVA, Banamex, HSBC, AMEX, Afirme,
              Inbursa y Openbank.
            </p>
            <ul className="ml-4 list-disc text-xs text-zinc-500">
              <li>
                Bonificaciones bancarias (sólo aplican en OP): BBVA, Banamex,
                HSBC y Klar
              </li>
              <li>
                Cashback en Point: pagando con Tarjeta de Crédito Mercado Pago
                (física)
              </li>
            </ul>
